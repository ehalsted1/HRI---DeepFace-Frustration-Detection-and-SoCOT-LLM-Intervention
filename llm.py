...
class Conversation(object):
    ...
    def __init__(self, mode="normal", conversation_path="", debug=None, interaction_state=None):
        ...
        prompt = {"role": "user", "parts": [{"text": """
                            ...
                            Then continue with light hearted and friendly questions from there, asking questions to understand and relate with the user. 
    ...
    def format_multiple_options(self, skip=False):
        ...
        regular_response = self.llm_chat()
